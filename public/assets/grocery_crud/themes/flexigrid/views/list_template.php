...
<script type='text/javascript'>
	// 'https://pre-tramits.idi.es/public/';
	...
	// ajax_list_info_url = ajax_list_info_url.replace("/index.php","/public/index.php");
	console.log( "#### "+ajax_list_info_url+" ####")
	var unique_hash = '<?php echo $unique_hash; ?>';
	console.log( "#### "+unique_hash+" ####")
	var export_url = '<?php echo $export_url; ?>';
	// export_url = export_url.replace("/index.php","/public/index.php");
