...
$email_message .= "<br><div>Per poder completar la vostra adhesió al programa Indústria Local Sostenible (ILS) necessitam l'Informe resum de la petjada de carboni. 
...
else 
{
	...
	$result = "<strong>Sol·licitud de l´Informe resum enviada a la adreça de notificació " .$correoDestino."</strong>";
}
