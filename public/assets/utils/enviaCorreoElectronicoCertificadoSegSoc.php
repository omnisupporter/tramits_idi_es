...
$mail->IsHTML(true);
$mail->CharSet = 'UTF-8'; 
$mail->Subject = "Solicitam certificat TGSS";
...
$email_message .= "<br><div>Per poder completar la vostra sol·licitud d'ajut necessitam el certificat de la TGSS. 
<br><br>Per a això, us demanam que ens faceu arribar aquest document a través del següent formulari:</div>";
$email_message .= "<div><a title='Obrir el formulari per fer-nos arribar el Certificat de la TGSS' href = 'https://tramits.idi.es/public/index.php/home/documento_certificado_tgss_idiisba/".$_POST["id"]."/".$nif."/".$tipoTramite."/".$convocatoria."/ca'>Formulari de requeriment del Certificat de la TGSS</a></div>";
...
else 
{
	...
	$result = "<strong>Sol·licitud del Certificat de la TGSS enviada a la adreça de notificació " .$correoDestino."</strong>";
}
