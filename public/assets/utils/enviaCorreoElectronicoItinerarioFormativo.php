...
$mail->IsHTML(true);
$mail->CharSet = 'UTF-8'; 
$mail->Subject = "Solicitam el document: itinerari formatiu - ILS";
...
$email_message .= "<br><div>Per completar l'adhesió al nostre programa ILS (Indústria Local Sostenible) ens fa falta l'itinerari formatiu sobre petjada de carboni 
