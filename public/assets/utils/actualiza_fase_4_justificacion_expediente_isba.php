...
if ( strlen($fecha_REC_justificacion) != 0) {
    $date_REC_requerimiento_justificacion = date_format(date_create($fecha_REC_justificacion), "Y-m-d H:i:s");
} else {
...
$query = "UPDATE pindust_expediente 
    SET  
    fecha_REC_justificacion = '" . $date_REC_requerimiento_justificacion  ."',
