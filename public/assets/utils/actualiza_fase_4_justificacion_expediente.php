...
if (strpos($fecha_REC_justificacion, "/") > 0) {
    ...
    $hora_REC_justificacion = $fecha_REC_justificacion[1];
    ...
    $fecha_REC_justificacion = $fecha_fecha_REC_justificacion[2]."-".$fecha_fecha_REC_justificacion[1]."-".$fecha_fecha_REC_justificacion[0] ." ".$hora_REC_justificacion;
}
