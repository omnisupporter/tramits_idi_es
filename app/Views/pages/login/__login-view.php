...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post"  action="<?= base_url('/public/index.php/loginController/login') ?>"> 
      <input type="text" id="user_id" required disabled name="user_id" placeholder="Adreça de correu">
    ...
    <div id="formFooter">
        <div><strong>Gestor d'ajuts i de subvencions</strong></div>
        <div><p>&copy; <?= date('Y') ?> Institut d'Innovació Empresarial</p></div>
