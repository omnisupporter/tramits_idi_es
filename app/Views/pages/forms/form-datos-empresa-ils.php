...
<article>
  ...
  <input type = "hidden" name="id_sol" id="id_sol" value = "<?php echo $data['expedientes']['id'];?>">
    ...
    <fieldset>  
	  ...
	  <fieldset> 
		  <legend><h4><strong><?php echo lang('message_lang.sitio_web_empresa_ils');?></strong></h4> </legend>
  			<section class="panel-justificacion">
	  				<div>
		  				<input type="text" id = "sitio_web_empresa" name = "sitio_web_empresa" required size = "20" />
					  </div>
			  </section>
		</fieldset>
    ...
    <fieldset> 
			...
			<section class="panel-justificacion">
					<div>
          <textarea id="canales_comercializacion_empresa" name="canales_comercializacion_empresa" title="<?php echo lang('message_lang.comercializacion_empresa_ils');?>" required placeholder = "<?php echo lang('message_lang.comercializacion_empresa_ils');?>" rows="3" cols="50"></textarea>
					</div>
			</section>		
		</fieldset>  
    ...
    <fieldset> 
			...
			<section class="panel-justificacion">
					<div>
						<input type = "date" id = "fecha_creacion_empresa" required name = "fecha_creacion_empresa" size = "20" />
					</div>
			</section>		
		</fieldset>  
