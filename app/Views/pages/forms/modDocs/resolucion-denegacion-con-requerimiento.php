  ...
  <div class="card-itramits-footer">
      ...
      if ( !$esAdmin && !$esConvoActual ) {?>
        <?php }
			...
			<button id="generadoc_res_denegacion_con_req" class='btn btn-primary' onclick="generaResolucionDenegacionConRequerimiento(<?php echo $id;?>, '<?php echo $convocatoria;?>', '<?php echo $programa;?>', '<?php echo $nifcif;?>')">Genera  la resolució</button>
