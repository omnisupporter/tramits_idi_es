...
<!-- <div class="card-itramits"> -->
      ...
      <?php }
			  ...
			  <button type = "button" class = "btn-primary-itramits" data-toggle = "modal" data-target = "#myEnviarFormularioItinerarioFormativo" id="myBtnEnviarFormularioItinerarioFormativo">PENDING -> Enviar al sol·licitant el formulari de sol·licitud de l'Itinerari formatiu ILS</button>       
		  <?php }?>
			...
			<div class="modal-dialog">
				<div class="modal-content">	
					<div class="modal-header">
						<label for="cerrarModalActaCierre"><strong>Sol·licitud de l'Itinerari formatiu ILS</strong></label>
        				<button id="cerrarModalActaCierre" type="button" class="close" data-dismiss="modal">&times;</button>
  					</div>
    				<div class="modal-body">
						<div class="form-group">
							<span>Vols enviar un correu electrònic al sol·licitant de l'adhesió a ILS perquè ens faci arribar l'itinerari formatiu?</span>
						</div>	
						<div class="form-group">
  ...
  <script>
  // Get the modal
  let modal_17ils_1 = document.getElementById("myEnviarFormularioItinerarioFormativo");
	// Get the button that opens the modal
	let btn_17ils_1 = document.getElementById("myBtnEnviarFormularioItinerarioFormativo");
