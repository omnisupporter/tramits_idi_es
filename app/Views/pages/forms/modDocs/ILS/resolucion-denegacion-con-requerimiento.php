...
<div class="card-itramits">
	...
	<div class="card-itramits-footer">
		...
		<?php } else { ?>
			<a id="generadoc_res_denegacion_con_req" class = "btn btn-primary" href="<?php echo base_url('public/index.php/expedientes/generainformeILS/' . $id . '/' . $convocatoria . '/' . $programa . '/' . $nifcif . '/doc_res_denegacion_con_req_ils'); ?>">Genera la resolució</a>
