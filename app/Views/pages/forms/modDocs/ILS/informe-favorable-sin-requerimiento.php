...
<div class="card-itramits">
	...
	<div class="card-itramits-footer">
        ...
        <?php }
			...
			<span id="btn_2" class="">	
    			<a id="generaInfFavSinReq" href="<?php echo base_url('public/index.php/expedientes/generainformeILS/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_informe_favorable_sin_requerimiento_ils');?>" class="btn-primary-itramits">Generar l'informe</a>
			</span>
