...
$pdf->SetTitle("RESOLUCIÓN DE CONCESIÓN CON REQUERIMIENTO ILS");
$pdf->SetSubject("RESOLUCIÓN DE CONCESIÓN CON REQUERIMIENTO ILS");
...
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_ils_resolucion_concesion_con_req_intro'));
...
$pdf->setY($currentY + 4);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_ils_resolucion_concesion_con_req_antecedentes') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$parrafo_1 = lang('message_lang.doc_ils_resolucion_concesion_con_req_p1');
$html = "<ol>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 10);
$resolucion = lang('message_lang.doc_ils_resolucion_concesion_con_req_resolucion');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$recursos = lang('message_lang.doc_ils_resolucion_concesion_con_req_inter_recursos');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$recursos_texto = lang('message_lang.doc_ils_resolucion_concesion_con_req_inter_recursos_texto');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$firma = lang('message_lang.doc_ils_resolucion_concesion_con_req_firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_resolucion_concesion_adhesion_con_req_ils.pdf', 'F');
