...
$pdf->SetTitle("INFORME FAVORABLE CON REQUERIMIENTO ILS");
$pdf->SetSubject("INFORME FAVORABLE CON REQUERIMIENTO ILS");
...
$html = "Document: informe favorable amb requeriment<br>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_ils_info_favorable_con_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_ils_info_favorable_con_req_hechos') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = lang('message_lang.doc_ils_info_favorable_con_req_p1');
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y") , lang('message_lang.doc_ils_info_favorable_con_req_p2'));
...
$parrafo_3 = str_replace("%FECHAREQUERIMIENTO%", date_format(date_create($data['expediente']['fecha_requerimiento_notif']),"d/m/Y") , lang('message_lang.doc_ils_info_favorable_con_req_p3'));
$html .= "<li>". $parrafo_3 ."</li>";
$html .= "<br>";

$parrafo_4 = str_replace("%FECHAENMIENDA%", date_format(date_create($data['expediente']['fecha_REC_enmienda']),"d/m/Y") , lang('message_lang.doc_ils_info_favorable_con_req_p4'));
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_informe_favorable_con_requerimiento_ils.pdf', 'F');