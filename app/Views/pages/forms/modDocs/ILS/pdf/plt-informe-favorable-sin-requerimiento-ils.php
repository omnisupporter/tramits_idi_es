...
$pdf->SetTitle("INFORME FAVORABLE SIN REQUERIMIENTO ILS");
$pdf->SetSubject("INFORME FAVORABLE SIN REQUERIMIENTO ILS");
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_ils_info_favorable_sin_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_ils_info_favorable_sin_req_hechos') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_ils_info_favorable_sin_req_p1'));
$parrafo_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB'], $parrafo_1);
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y"), lang('message_lang.doc_ils_info_favorable_sin_req_p2'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$parrafo_conclusion = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_ils_info_favorable_sin_req_conclusion'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_pre = lang('message_lang.doc_ils_info_favorable_sin_req_preconclusion');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_informe_favorable_sin_requerimiento_ils.pdf', 'F');