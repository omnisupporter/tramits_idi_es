...
$pdf->SetTitle("RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO ILS");
$pdf->SetSubject("RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO ILS");
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_ils_resolucion_denegacion_con_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_ils_resolucion_denegacion_con_req_antecedentes') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_ils_resolucion_denegacion_con_req_p1'));
$parrafo_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB'], $parrafo_1);
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y") , lang('message_lang.doc_ils_resolucion_denegacion_con_req_p2'));
...
$parrafo_3 = str_replace("%FECHANOTIF%", date_format(date_create($data['expediente']['fecha_requerimiento_notif']),"d/m/Y") , lang('message_lang.doc_ils_resolucion_denegacion_con_req_p3'));
$html .= "<li>". $parrafo_3 ."</li>";
$html .= "<br>";

$parrafo_4 = str_replace("%FECHAENMIENDA%", date_format(date_create($data['expediente']['fecha_REC_enmienda']),"d/m/Y") , lang('message_lang.doc_ils_resolucion_denegacion_con_req_p4'));
...
$parrafo_4 = str_replace("%NUMENMIENDAREC%", $data['expediente']['ref_REC_enmienda'], $parrafo_4);
$html .= "<li>". $parrafo_4 ."</li>";
$html .= "<br>";

$parrafo_5 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_p5');
$html .= "<li>". $parrafo_5 ."</li>";
$html .= "<br>";

$parrafo_6 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_p6');
$parrafo_6 = str_replace("%FECHAINFORDESF%", date_format(date_create($data['expediente']['fecha_infor_desf']),"d/m/Y") , $parrafo_6);
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$req_fundamentos_1 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_resol_p1');
$req_fundamentos_1 = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], $req_fundamentos_1);
$req_fundamentos_1 = str_replace("%NIF%", $data['expediente']['nif'], $req_fundamentos_1);
$html = "<ol>";
$html .= "<li>". $req_fundamentos_1 ."</li>";
$html .= "<br>";

$req_fundamentos_2 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_resol_p2');
$html .= "<li>". $req_fundamentos_2 ."</li>";
$html .= "<br>";

$req_fundamentos_3 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_resol_p3');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$resolucion = lang('message_lang.doc_ils_resolucion_denegacion_con_req_recursos_intro');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion_1 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_recursos_p1');
$html = "<ol>";
$html .= "<li>". $resolucion_1 ."</li>";
$html .= "<br>";

$resolucion_2 = lang('message_lang.doc_ils_resolucion_denegacion_con_req_recursos_p2');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$firma = lang('message_lang.doc_ils_resolucion_denegacion_con_req_recursos_firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_res_denegacion_con_req_ils.pdf', 'F');
