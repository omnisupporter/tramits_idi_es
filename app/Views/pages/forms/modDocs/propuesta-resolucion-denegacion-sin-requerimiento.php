...
<div class="card-itramits">
	...
	<div class="card-itramits-footer" aria-label="generar informe">
		...
		<?php } else { ?>
			...
			<span id="btn_8" class="">
				<button id="wrapper_motivoDenegacion_8" class='btn btn-primary ocultar' onclick="enviaPropuestaResDenegacionSinRequerimiento(<?php echo $id; ?>, '<?php echo $convocatoria; ?>', '<?php echo $programa; ?>', '<?php echo $nifcif; ?>')">Envia a signar</button>
