...
<div class="card-itramits">
  	...
  	<div class="btn-group" role="group" aria-label="generar informe">
        ...
        <?php }
			...
			<button type = "button" class = "btn-primary-itramits" data-bs-toggle="modal" data-bs-target="#myDenegacion_9" id="myBtnResDenegacionSinReq">Motiu de la denegació</button>
			<span id="btn_9" class="">
...
<!-- 			<a class='btn btn-ver-itramits' href="<?php echo base_url('public/index.php/expedientes/muestrainforme/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_prop_res_denegacion_sin_req');?>" 
		...
		<?php }?>
      <!-- The Modal -->
			<div class="modal"  id="myDenegacion_9">
