...
<div class="card-itramits">
  	...
  	<div class="card-itramits-footer">
        ...
        <?php }
	  		...
	  		<button type = "button" class = "btn btn-secondary btn-acto-admin"  id="myBtnactaDeKickOff" onclick="actaDeKickOff(<?php echo $id; ?>, '<?php echo $convocatoria; ?>', '<?php echo $programa; ?>', '<?php echo $nifcif; ?>')">Genera l'acta</button>   
			<?php }?>	
