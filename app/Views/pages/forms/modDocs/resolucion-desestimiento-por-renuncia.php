<!----------------------------------------- Resolució desistiment SIN VIAFIRMA --------------------------------->
  ...
  <div class="card-itramits-body">
	  ...
	  <?php
        ...
        <?php }
			...
			<button type = "button" class = "btn-primary-itramits" data-toggle = "modal" data-target = "#myDesestimientoRenuncia" id="myBtnDesestimientoRenuncia">Desistiment per renúncia</button>  
			<span id="btn_14" class="">
    			<a id ="wrapper_motivoDesestimientoRenuncia" class="ocultar" href="<?php echo base_url('public/index.php/expedientes/generaInforme/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_res_desestimiento_por_renuncia');?>"><i class='fa fa-info'></i> Generar el PDF de desistiment per renúncia</a>
			</span>		
	...
	<?php if ($expedientes['doc_res_desestimiento_por_renuncia'] !=0) { ?>
        <a	class='btn btn-ver-itramits' href="<?php echo base_url('public/index.php/expedientes/muestrainforme/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_res_desestimiento_por_renuncia');?>" target = "_self"><i class='fa fa-check'></i>El desistiment per renúncia</a>	
		<?php }?>
	<?php //} else {?>
