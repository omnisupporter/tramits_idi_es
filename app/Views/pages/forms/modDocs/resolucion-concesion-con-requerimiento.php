...
<script>
	...
	function generaResolucionConcesionFavConReq(id, convocatoria, programa, nifcif) {
		...
		if(!fecha_REC.value) {
			infoMissingDataDoc15.innerHTML = infoMissingDataDoc15.innerHTML + "Data SEU sol·licitud<br>"
			todoBien = false
		}
		if(!ref_REC.value) {
			infoMissingDataDoc15.innerHTML = infoMissingDataDoc15.innerHTML + "Referència SEU sol·licitud<br>"
			todoBien = false
		}
