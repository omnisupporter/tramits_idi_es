...
<div class="card-itramits">
  	<div class="card-itramits-body">
    	Informe inici requeriment d'esmena
	</div>
	<div class="card-itramits-footer">
        ...
        <?php }
			...
			<span id="btn_177" class="">
    			<a id="wrapper_inicio_req_subsanacion" class="ocultar" href="<?php echo base_url('public/index.php/expedientes/generaInforme/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_inicio_requerimiento_subsanacion');?>" class="btn-primary-itramits">Envia a signar el requeriment</a>
			</span>
	...
	<?php if ($expedientes['doc_inicio_requerimiento_subsanacion'] !=0) { ?>
		<a	class='btn btn-ver-itramits' class="ocultar" href="<?php echo base_url('public/index.php/expedientes/muestrainforme/'.$id.'/'.$convocatoria.'/'.$programa.'/'.$nifcif.'/doc_inicio_requerimiento_subsanacion');?>" target = "_self"><i class='fa fa-check'></i>Inici requeriment d’esmena</a>		
		<?php }?>
		<?php
