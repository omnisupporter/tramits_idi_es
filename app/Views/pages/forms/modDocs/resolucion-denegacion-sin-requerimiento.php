...
<div class="card-itramits">
  ...
  <div class="card-itramits-footer">
      ...
      <?php }
				...
				<button id="generadoc_res_denegacion_sin_req" class='btn btn-primary btn-acto-admin' onclick="generaResolucionDenegacionSinRequerimiento(<?php echo $id;?>, '<?php echo $convocatoria;?>', '<?php echo $programa;?>', '<?php echo $nifcif;?>')">Genera  la resolució</button>
