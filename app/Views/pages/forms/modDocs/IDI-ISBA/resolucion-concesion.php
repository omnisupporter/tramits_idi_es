...
<div class="card-itramits">
	...
	pre-tramits
		...
		<?php } else { ?>
			<button id="wrapper_ResConcesionConReg" onclick="enviaResolucionConcesionConReg(<?php echo $id; ?>, '<?php echo $convocatoria; ?>', '<?php echo $programa; ?>', '<?php echo $nifcif; ?>')"><i title="Generar la resolució" class="fa-solid fa-file-pdf fa-2xl" style="color: #00145c;"></i></button>
...
<script>
	function enviaResolucionConcesionConReg(id, convocatoria, programa, nifcif) {
		...
		if (todoBien) {
			...
			wrapper_ResConcesionConReg.innerHTML = "Generant la resolució ..."
