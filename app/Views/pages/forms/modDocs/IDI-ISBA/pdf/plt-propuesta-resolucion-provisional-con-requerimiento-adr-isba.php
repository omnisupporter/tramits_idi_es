...
$parrafo_7 = str_replace("%IMPORTEAYUDA%", $data['expediente']['importe_ayuda_solicita_idi_isba'], lang('isba_6_propuesta_resolucion_prov_favorable_con_requerimiento.propuestaresoluciondef_1_2_3'));
...
$parrafo_8 = str_replace("%IMPORTEAYUDA%", $data['expediente']['importe_ayuda_solicita_idi_isba'], lang('isba_6_propuesta_resolucion_prov_favorable_con_requerimiento.propuestaresoluciondef_4_5'));
