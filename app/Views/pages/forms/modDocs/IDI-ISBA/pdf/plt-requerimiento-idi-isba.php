...
$pdf->SetTitle("DOCUMENT DE REQUERIMENT - ADR Balears-ISBA");
$pdf->SetSubject("DOCUMENT DE REQUERIMENT - ADR Balears-ISBA");
$pdf->SetKeywords("INDUSTRIA 4.0, DIAGNOSTIC, DIGITAL, EXPORTA, ISBA, PIMES, ADR Balears, CAIB");	
