...
$pdf->SetTitle("PROPUESTA RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO");
$pdf->SetSubject("PROPUESTA RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO");
...
$parrafo_4 = str_replace("%FECHAPROPDENEGACION%", date_format(date_create($data['expediente']['fecha_propuesta_denegacion']),"d/m/Y") , lang('message_lang.doc_prop_resolucion_denegacion_con_req_p4'));
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_prop_res_denegacion_con_req.pdf', 'F');