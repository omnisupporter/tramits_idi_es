...
$pdf->SetTitle("PROPUESTA RESOLUCIÓN DENEGACIÓN SIN REQUERIMIENTO");
$pdf->SetSubject("PROPUESTA RESOLUCIÓN DENEGACIÓN SIN REQUERIMIENTO");
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_prop_resolucion_denegacion_sin_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_prop_resolucion_denegacion_sin_req_antecedentes') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_prop_resolucion_denegacion_sin_req_p1'));
$parrafo_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB'], $parrafo_1);
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y") , lang('message_lang.doc_prop_resolucion_denegacion_sin_req_p2'));
...
$parrafo_4 = str_replace("%FECHANOTPROPRESDENEGACION%", date_format(date_create($data['expediente']['fecha_not_propuesta_denegacion']),"d/m/Y") , $parrafo_4);
$html .= "<li>". $parrafo_4 ."</li>";
$html .= "<br>";

$parrafo_5 = str_replace("%FECHAINFORFAV%", date_format(date_create($data['expediente']['fecha_infor_fav_desf']),"d/m/Y") , lang('message_lang.doc_prop_resolucion_denegacion_sin_req_p5'));
...
$req_fundamentos = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_fundamentos');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$req_fundamentos_1 = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_fundamentos_1');
$html = "<ol>";
$html .= "<li>". $req_fundamentos_1 ."</li>";
$html .= "<br>";

$req_fundamentos_2 = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_fundamentos_2');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$dicto = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_dicto');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$resolucion = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_resolucion');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$resolucion_1 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']) , lang('message_lang.doc_prop_resolucion_denegacion_sin_req_resolucion_1'));
...
$resolucion_2 = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_resolucion_2');
$html .= "<li>". $resolucion_2 ."</li>";
$html .= "<br>";

$resolucion_3 = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_resolucion_3');
...
$firma = lang('message_lang.doc_prop_resolucion_denegacion_sin_req_firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_prop_res_denegacion_sin_req.pdf', 'F');