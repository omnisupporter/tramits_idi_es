...
$pdf->SetTitle("RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO");
$pdf->SetSubject("RESOLUCIÓN DENEGACIÓN CON REQUERIMIENTO");
...
$html = "Document: resolució de denegació<br>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_resolucion_denegacion_con_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_resolucion_denegacion_con_req_antecedentes') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_resolucion_denegacion_con_req_p1'));
$parrafo_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB'], $parrafo_1);
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y") , lang('message_lang.doc_resolucion_denegacion_con_req_p2'));
...
if ($ultimaMejora[2] && $ultimaMejora[3]) {
    $parrafo_3m = str_replace("%FECHARECM%", date_format(date_create($ultimaMejora[2]),"d/m/Y") , lang('message_lang.doc_resolucion_denegacion_con_req_p3m'));
    $parrafo_3m = str_replace("%REFRECM%", $ultimaMejora[3], $parrafo_3m);
    $html .= "<li>". $parrafo_3m ."</li>";
    $html .= "<br>";
}

$parrafo_3 = str_replace("%FECHAENMIENDA%", date_format(date_create($data['expediente']['fecha_REC_enmienda']),"d/m/Y") , lang('message_lang.doc_resolucion_denegacion_con_req_p3'));
...
$parrafo_4 = str_replace("%FECHAINFORFAV%", date_format(date_create($data['expediente']['fecha_propuesta_resolucion']),"d/m/Y") , lang('message_lang.doc_resolucion_denegacion_con_req_p4'));
...
$parrafo_4 = str_replace("%NOTPROPDENEGATORIA%", date_format(date_create($data['expediente']['fecha_propuesta_resolucion_notif']),"d/m/Y") , $parrafo_4);
$html .= "<li>". $parrafo_4 ."</li>";
$html .= "<br>";

$parrafo_5 = lang('message_lang.doc_resolucion_denegacion_con_req_p5');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$req_fundamentos = lang('message_lang.doc_resolucion_denegacion_con_req_fundamentos');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$req_fundamentos_1 = lang('message_lang.doc_resolucion_denegacion_con_req_fundamentos_1');
$html = "<ol>";
$html .= "<li>". $req_fundamentos_1 ."</li>";
$html .= "<br>";

$req_fundamentos_2 = lang('message_lang.doc_resolucion_denegacion_con_req_fundamentos_2');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$dicto = lang('message_lang.doc_resolucion_denegacion_con_req_dicto');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion = lang('message_lang.doc_resolucion_denegacion_con_req_resolucion');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion_1 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']), lang('message_lang.doc_resolucion_denegacion_con_req_resolucion_1'));
...
$resolucion_2 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']), lang('message_lang.doc_resolucion_denegacion_con_req_resolucion_2'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$recursos = lang('message_lang.doc_resolucion_denegacion_con_req_inter_recursos');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion_5 = lang('message_lang.doc_resolucion_denegacion_con_req_inter_recursos_texto');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_res_denegacion_con_req.pdf', 'F');
