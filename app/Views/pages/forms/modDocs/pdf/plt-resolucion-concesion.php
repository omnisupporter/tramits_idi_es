...
$pdf->SetTitle("RESOLUCIÓN DE CONCESIÓN");
$pdf->SetSubject("RESOLUCIÓN DE CONCESIÓN");
...
$intro = str_replace("%fecha_propuesta_resolucion_notif%", date_format(date_create($data['expediente']['fecha_propuesta_resolucion_notif']),"d/m/Y"), $intro);
...
$resolucion_1 = str_replace("%BOIB%", $data['configuracionLinea']['num_BOIB'], $resolucion_1);
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$firma = lang('message_lang.doc_resolucion_concesion_sin_req_firma');
