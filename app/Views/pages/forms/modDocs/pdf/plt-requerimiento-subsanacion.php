...
$pdf->SetTitle("REQUERIMIENT FASE DE JUSTIFICACIÓ");
$pdf->SetSubject("REQUERIMIENT FASE DE JUSTIFICACIÓ");
...
$html =  "Document: requeriment fase justificació<br>";
...
$asunto = lang('message_lang.doc_requerimiento_subsanacion_asunto');
$asunto = str_replace("%BOIBNUM%", $data['configuracion']['num_BOIB'], $asunto);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". $asunto ."</b></td></tr>";
$html .= "</table>";
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_1 = str_replace("%BOIBNUM%", $data['configuracion']['num_BOIB'], lang('message_lang.doc_requerimiento_subsanacion_p1'));
$parrafo_1 = str_replace("%FECHAFIRMARESOLUCION%", date_format(date_create($data['expediente']['fecha_resolucion']),"d/m/Y"), $parrafo_1);
...
$parrafo_1 = str_replace("%PROGRAMA%", $data['expediente']['tipo_tramite'], $parrafo_1);
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_2 = lang('message_lang.doc_requerimiento_subsanacion_p2');
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_3 = lang('message_lang.doc_requerimiento_subsanacion_p3');
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_4 = str_replace("%FECHAINICIOREQJUSTIFICACION%", date_format(date_create($data['expediente']['fecha_inicio_req_justificacion']),"d/m/Y"), lang('message_lang.doc_requerimiento_subsanacion_p4'));
$parrafo_4 =  str_replace("%TEXTOLIBREREQ%", $data['expediente']['motivoRequerimientoSubsanacion'], $parrafo_4);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_5 = lang('message_lang.doc_requerimiento_subsanacion_p5');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'>". $parrafo_5 ."</td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');
...
$pdf->setX($currentX - 10);
$firma = lang('message_lang.doc_requerimiento_subsanacion_firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_requerimiento_subsanacion.pdf', 'F');