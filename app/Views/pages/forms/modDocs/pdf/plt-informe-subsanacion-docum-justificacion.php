...
$pdf->SetTitle("INFORME SOBRE L'ESMENA DE LA DOCUMENTACIÓ DE JUSTIFICACIÓ");
$pdf->SetSubject("INFORME SOBRE L'ESMENA DE LA DOCUMENTACIÓ DE JUSTIFICACIÓ");
...
$asunto = lang('message_lang.doc_informe_subsancion_documentacion_asunto');
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_1 = str_replace("%BOIBNUM%", $data['configuracionLinea']['num_BOIB'], lang('message_lang.doc_informe_subsancion_documentacion_p1'));
$parrafo_1 = str_replace("%FECHAFIRMARESOLUCION%", date_format(date_create($data['expediente']['fecha_propuesta_resolucion']),"d/m/Y"), $parrafo_1);
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_2 = lang('message_lang.doc_informe_subsancion_documentacion_p2');
$parrafo_2 = str_replace("%FECHANOTIFREQUERIMIENTO%", date_format(date_create($data['expediente']['fecha_firma_requerimiento_justificacion']),"d/m/Y"), $parrafo_2);
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_3 = lang('message_lang.doc_informe_subsancion_documentacion_p3');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_4 = str_replace("%TEXTOLIBRE%", $data['expediente']['motivoSobreSubsanacion'], lang('message_lang.doc_informe_subsancion_documentacion_P4'));
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$conclusion = str_replace("%TEXTOLIBRE%", $data['expediente']['propuestaTecnicoSobreSubsanacion'], lang('message_lang.doc_informe_subsancion_documentacion_conclusion'));
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
