...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_info_favorable_sin_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_info_favorable_sin_req_hechos') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_info_favorable_sin_req_p1'));
...
if ($ultimaMejora[2] && $ultimaMejora[3]) {
    $parrafo_3m = str_replace("%FECHARECM%", date_format(date_create($ultimaMejora[2]),"d/m/Y") , lang('message_lang.doc_info_favorable_sin_req_p3m'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$parrafo_pre = lang('message_lang.doc_info_favorable_sin_req_preconclusion');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_conclusion = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_info_favorable_sin_req_conclusion'));
