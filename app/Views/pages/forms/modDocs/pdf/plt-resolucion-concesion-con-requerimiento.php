...
$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB_modific'], lang('message_lang.doc_resolucion_concesion_con_req_p1_1'));
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_3 = str_replace("%FECHAENMIENDA%", date_format(date_create($data['expediente']['fecha_REC_enmienda']),"d/m/Y") , lang('message_lang.doc_resolucion_concesion_con_req_p3'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_4 = str_replace("%FECHAINFORFAV%", date_format(date_create($data['expediente']['fecha_infor_fav_desf']),"d/m/Y") ,lang('message_lang.doc_resolucion_concesion_con_req_p4'));
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_5 = str_replace("%FECHAPROPRES%", date_format(date_create($data['expediente']['fecha_propuesta_resolucion']),"d/m/Y") , lang('message_lang.doc_resolucion_concesion_con_req_p5'));
...
$parrafo_5 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']), $parrafo_5);
$parrafo_5 = str_replace("%PROGRAMA%", $data['expediente']['tipo_tramite'], $parrafo_5);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_res_conces_con_req.pdf', 'F');
