...
$pdf->setY($currentY + 5);
$pdf->setX($currentX - 10);
$parrafo_4 = str_replace("%FECHAINICIOREQJUSTIFICACION%", date_format(date_create($data['expediente']['fecha_firma_requerimiento_justificacion']),"d/m/Y"), lang('message_lang.doc_requerimiento_subsanacion_p4'));
