...
$pdf->SetTitle("PROPUESTA RESOLUCIÓN CONCESIÓN CON REQUERIMIENTO");
$pdf->SetSubject("PROPUESTA RESOLUCIÓN CONCESIÓN CON REQUERIMIENTO");
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('message_lang.doc_prop_resolucion_concesion_con_req_intro'));
...
$pdf->setY($currentY + 6);
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
$html .= "<tr><td style='background-color:#ffffff;color:#000;font-size:14px;'><b>". lang('message_lang.doc_prop_resolucion_concesion_con_req_antecedentes') ."</b></td></tr>";
$html .= "</table>";
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('message_lang.doc_prop_resolucion_concesion_con_req_p1'));
$parrafo_1 = str_replace("%BOIB%", $data['configuracion']['num_BOIB'], $parrafo_1);
$html = "<ol>";
$html .= "<li>". $parrafo_1 ."</li>";
$html .= "<br>";

$parrafo_2 = str_replace("%FECHAREC%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y") , lang('message_lang.doc_prop_resolucion_concesion_con_req_p2'));
...
$parrafo_5 = str_replace("%FECHAINFORFAV%", date_format(date_create($data['expediente']['fecha_infor_fav_desf']),"d/m/Y") , lang('message_lang.doc_prop_resolucion_concesion_con_req_p5'));
...
$req_fundamentos = lang('message_lang.doc_prop_resolucion_concesion_con_req_fundamentos');
$html = "<table cellpadding='5' style='width: 100%;border: 1px solid #ffffff;'>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 2);
$req_fundamentos_1 = lang('message_lang.doc_prop_resolucion_concesion_con_req_fundamentos_1');
$html = "<ol>";
$html .= "<li>". $req_fundamentos_1 ."</li>";
$html .= "<br>";

$req_fundamentos_2 = lang('message_lang.doc_prop_resolucion_concesion_con_req_fundamentos_2');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion_1 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']) , lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_1'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$resolucion_2 = str_replace("%IMPORTE%", money_format("%i ", $data['expediente']['importeAyuda']), lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_2'));
...
$resolucion_3 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_3');
$html .= "<li>". $resolucion_3 ."</li>";
$html .= "<br>";

$resolucion_4 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_4');
$html .= "<li>". $resolucion_4 ."</li>";
$html .= "<br>";

$resolucion_5 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_5');
$html .= "<li>". $resolucion_5 ."</li>";
$html .= "<br>";

$resolucion_6 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_6');
$html .= "<li>". $resolucion_6 ."</li>";
$html .= "<br>";

$resolucion_7 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_7');
$html .= "<li>". $resolucion_7 ."</li>";
$html .= "<br>";

$resolucion_8 = lang('message_lang.doc_prop_resolucion_concesion_con_req_resolucion_8');
$html .= "<li>". $resolucion_8 ."</li>";
$html .= "</ol>";
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 3);
$recursos_1 = lang('message_lang.doc_prop_resolucion_concesion_con_req_recursos_p1');
$html = "<ol>";
...
/* $currentX = $pdf->getX();
$pdf->setY($currentX + 10); */
$firma = lang('message_lang.doc_prop_resolucion_concesion_con_req_firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_prop_res_conces_con_req.pdf', 'F');