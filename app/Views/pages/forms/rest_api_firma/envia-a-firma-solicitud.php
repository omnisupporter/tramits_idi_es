<?php
		...
		$doc->filename = $nif.'_dec_res_solicitud.pdf';
		$doc->base64 = chunk_split(base64_encode(file_get_contents(WRITEPATH.'documentos/'.$nif.'/'.$selloDeTiempo.'/'.$nif.'_dec_res_solicitud.pdf')));	
	...
	function printResult($result, $last_insert_id, $tipo_Doc) {
		...
		// echo "<pre><code>".$last_insert_id."</code></pre>";
