...
include ("PHPMailer_5.2.0/class.phpmailer.php");
	...
	$emailDest = $_POST["mail_consultor"];
...
// When sending email using PHPMailer, you need to send from a valid email address
	...
	// Con copia oculta
	$mail->AddBCC("illado@idi.es", "Servei de Política Industrial");
	// El destinatario.
	...
	$email_message .= "<tbody>";
	$email_message .= "<tr style='width:100%;text-align:left;'><td><span style='font-size: 14px;'>";
	$email_message .= lang('message_lang.texto_mail_intro_1')." <strong>". $empresa ."</strong> ".lang('message_lang.texto_mail_intro_2');
	$email_message .= "<a title='pindust.idi.es' href = 'http://pindust.idi.es/home/dec_resp_consul/$last_insert_id'>".lang('message_lang.texto_enlace')."</a></span></td></tr>";
	...
	$email_message .= "<br>";
	$email_message .= "<br>";	
	$email_message .= "<p style='width:100%;text-align:left;'><span style='font-size: 14px;'>".lang('message_lang.atentamente')."</span></p>";
...
{
	// echo lang('message_lang.enviado_correo_ok'). $emailDest;
}
?>