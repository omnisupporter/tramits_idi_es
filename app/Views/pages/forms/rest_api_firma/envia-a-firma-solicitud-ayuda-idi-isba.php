...
/* 		$user->userName = $empresa; // "wwwwwwwwwwwwwwww";
		...
		$doc->filename = $nif.'_dec_res_solicitud_idi_isba.pdf';
		$doc->base64 = chunk_split(base64_encode(file_get_contents(WRITEPATH.'documentos/'.$nif.'/'.$selloDeTiempo.'/'.$nif.'_dec_res_solicitud_idi_isba.pdf')));	
