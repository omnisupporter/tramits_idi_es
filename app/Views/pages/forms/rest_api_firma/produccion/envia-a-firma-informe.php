...
<?php	
		...
		/* require_once dirname(__FILE__) . '/model/StampPosition.php'; */ //COMENTADO PORQUE EN VERSIÓN PRODUCCIÓN NO ES COMPATIBLE
		...
		/* echo "+++".$byCEOSigned."+++".$adreca_mail."+++".$telefono_cont."+++"; */
