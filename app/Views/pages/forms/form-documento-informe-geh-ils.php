...
<article>
  ...
  <div class="alert alert-info">
		<h3><strong><?php echo lang('message_lang.solicitud_doc_informe_GEH_ils_titulo');?></strong></h3>
  </div>

  <form action="<?php echo base_url('/public/index.php/expedientes/do_doc_informe_GEH_upload/'.$data['expedientes']['id'].'/'.$data['expedientes']['nif'].'/'.$data['expedientes']['tipo_tramite'].'/'.$data['expedientes']['convocatoria'].'/'. $idioma);?>" name="form_informeGEH" id="form_informeGEH" method="post" accept-charset="utf-8" enctype="multipart/form-data">
