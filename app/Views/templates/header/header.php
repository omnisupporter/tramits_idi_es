...
<div id="main">
	...
	<button type="button" onclick="openNav()" class="btn btn-dark"><i class="bi bi-menu-app"></i></button>
		<img title="Institut d'Innovació Empresarial de les Illes Balears" height="30"
