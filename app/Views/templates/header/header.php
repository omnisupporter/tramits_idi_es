...
<div id="mySidenav" class="sidenav">
  ...
  <div class="menu">
		<ul>
			...
			<!--<li class="menu-item"><img height="54" title="L'avatar de l'usuari de Gsuite" alt="L'avatar de l'usuari de Gsuite" src="<?php echo $session->get('avatar');?>"></li>-->
			<!--<li class="menu-item">
...
<!-- 			<?php if ($session->get('rol')=='admin') {?>	
			...
			<?php if ($session->get('rol')=='admin') {?>	
				<li class="menu-item">
					<!--<a title="Generar un arxiu EXCEL amb les ordres de pagament" href="<?php echo base_url('/public/index.php/crud/payment_orders/export?search_text=SI&search_field=ordenDePago');?>" download="">Exportar ordres de pagament</a>-->
			...
			<li class="menu-item"><button class = "btn btn-logout" title = "Sortida" onclick = "signOut()"><i class="fas fa-power-off" style='color:orange;'></i></button></li>
...
<div id="main">		
	<span style="font-size:45px;cursor:pointer" onclick="openNav()">&#9776;
		<img title="Institut d'Innovació Empresarial de les Illes Balears" height="35"
		alt="Visita la web oficial del IDI"
		src="data:image/png;base64,">	
	</span>
	<div class="heroe"><h1><?= esc($titulo); ?></h1></div>
