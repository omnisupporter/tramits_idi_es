...
class App extends BaseConfig
{
	...
	*/
	...
	public $baseURL = 'https://pre-tramits.idi.es/public/';
	/*
	|--------------------------------------------------------------------------
	| Index File
	|--------------------------------------------------------------------------
	...
	*/
	...
	public $sessionCookieName        = 'itramits_session';
	public $sessionExpiration        = 3600; //segundos
	public $sessionSavePath          = 'session';
	public $sessionMatchIP           = true; //Validate the user’s IP address when reading the session cookie.
	...
	|
	*/
	public $cookiePrefix   = 'itramits';
	public $cookieDomain   = 'idi.es';
	public $cookiePath     = '/';
