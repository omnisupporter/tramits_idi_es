...
class App extends BaseConfig
{
	...
	*/
	...
	// public $baseURL = 'http://pindust.idi.es/';
	public $baseURL = 'https://tramits.idi.es/';
	/*
	|--------------------------------------------------------------------------
	| Index File
	|--------------------------------------------------------------------------
	...
	*/
	...
	public $sessionCookieName        = 'iTramits_';
	public $sessionExpiration        = 3600; // timeOut en segundos
