...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
    ...
    public function set_css($css_file)
    {
        ...
        $this->css_files[sha1($css_file)] = base_url(). '/public/' . $css_file;
    }

    public function set_js($js_file)
    {
        // $this->js_files[sha1($js_file)] = base_url(). '/' .$js_file;
        $this->js_files[sha1($js_file)] = base_url(). '/public/' .$js_file;
    }

    public function set_js_lib($js_file)
    {
        // $this->js_lib_files[sha1($js_file)] = base_url(). '/' .$js_file;
        $this->js_lib_files[sha1($js_file)] = base_url(). '/public/' .$js_file;
    ...
    public function set_js_config($js_file)
    {
        ...
        $this->js_config_files[sha1($js_file)] = base_url(). '/public/' .$js_file;
    ...
    {
        // echo "******* ".$this->default_javascript_path." ***********";
...
class grocery_CRUD_States extends grocery_CRUD_Layout
{
    ...
    protected function state_url($url = '', $is_list_page = false)
    {
        ...
        /**
         * Al tener configurada en la aplicación un base_url() distinto al que
         * usa este plugin, modificaré el de este para añadirle a la url la referencia '/public/'
         */

        $state_url = str_replace('/index.php/','/public/index.php/',$state_url);
        return $state_url;
    }
...
class GroceryCrud extends grocery_CRUD_States
{
    ...
    protected function _initialize_variables()
    {
        ...
        // echo "default assets path: " .$this->default_assets_path . " -----";
