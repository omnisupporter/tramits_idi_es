...
class Expedientes extends Controller
{
	...
	public function edit($id)
	{
		...
		if ($tipo_tramite == 'Programa IV' || $tipo_tramite == 'Programa III actuaciones corporativas' || $tipo_tramite == 'Programa III actuaciones producto' || $tipo_tramite == 'Programa III' || $tipo_tramite == 'Programa II' || $tipo_tramite == 'Programa I') {
	...
	public function generainforme()
	{
		...
		switch ($tipoDocumento) {
			...
			case "doc_res_denegacion_con_req": //DOC 11 - CON VIAFIRMA. A GERENCIA o DIRECCIÓN GENERAL
				$data_infor = [
			...
			case "doc_res_denegacion_sin_req": //DOC 12 - CON VIAFIRMA. A GERENCIA o DIRECCIÓN GENERAL
				$data_infor = [
