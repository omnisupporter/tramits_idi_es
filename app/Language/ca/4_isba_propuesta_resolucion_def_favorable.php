return [
  '3_intro' => "Proposta de resolució definitiva de la directora gerent de l’Agència de Desenvolupament Regional de les Illes Balears sobre la concessió d’una subvenció a %SOLICITANTE%, destinada a cobrir les despeses financeres d’operacions de finançament d’inversions productives",
  '3_antecedentes_tit' => "Fets",
  '3_antecedentes_1_2_3_4' => "<ol>
  ...
  '3_antecedentes_5' => "<li>El/la tècnic/a de l’ADR Balears ha examinat la sol·licitud presentada per %SOLICITANTE%, i ha comprovat que:</li><br>
			<ul>
 ...
 '3_antecedentes_6_7_8_9_10_11_12' => "<li>D’acord amb l’establert a la resolució de convocatòria, els ajuts concedits en el marc d’aquesta convocatòria constitueixen ajuts d’Estat regulats en els articles 107 i 108 del Tractat de Funcionament de la Unió Europea dels ajuts de minimis (reglament núm. 1407/2013), i al reglament (UE) 2023/2831 de la comissió, de 13 de desembre de 2023, relatiu a l’aplicació dels articles 107 i 108 del Tractat.</li><br>
			...
			<li>En data %FECHA_PROPUESTA_RESOLUCION_PROVISIONAL% la directora gerent de l’Agència de Desenvolupament Regional de les Illes Balears ha dictat la proposta de resolució provisional en els següents termes:</li><br>  
			<ul>
			...
			<li>proposta de resolució provisional es va notificar a l’entitat interessada el %FECHA_NOTIFICACION_PR_PROV%.</li><br> 			
			<li>Exhaurit el termini per presentar al·legacions, no consta que s’hagin presentat al·legacions per part de la persona interessada.</li></ol>", 
  '3_fundamentosDeDerecho_tit' => "Fonaments de dret",
  '3_fundamentosDeDerechoTxt' => "<ol>
  ...
  '3_propuestaresoluciondef_tit' => "Proposta de resolució definitiva",

  '3_propuestaresoluciondefTxt' => "Propòs al president de l’Agència de Desenvolupament Regional de les Illes Balears que dicti una resolució en els termes següents:",

  '3_propuestaresoluciondef_1_2_3_4_5_6' => "<ol>
  ...
  '3_firma' => "Palma, en data de la signatura electrònica<br><br>La directora gerent de l’Agència de Desenvolupament Regional de les Illes Balears<br>%DGERENTE%<br>"
];