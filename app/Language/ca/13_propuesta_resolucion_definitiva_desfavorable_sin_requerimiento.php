return [
  ...
  '13_antecedentes_4_m' => "<li>En data %FECHAREC%, l'IDI va rebre documentació  per completar la sol·licitud en concepte de millora amb registre d'entrada núm. %NUMRECMEJORA%</li><br>", 
  '13_antecedentes_5_6_7_8' => "<li>La tècnica de l'IDI ha examinat la sol·licitud presentada per %SOLICITANTE%, i ha comprovat que el sol·licitant no compleix amb els requisits establerts a la convocatòria.</li><br>
  ...
  '13_fundamentosDeDerecho_tit' => "Fonaments de dret",
  ...
  '13_propuestaresoluciondef_tit' => "Proposta de resolució definitiva",

  '13_propuestaresoluciondefTxt' => "Propòs al president de l'IDI que dicti una resolució en els termes següents:",

  '13_propuestaresoluciondef'  => "<ol>
  ...
  '13_firma' => "Palma, en data de la signatura electrònica<br><br>La directora gerent de l'IDI<br>%DGERENTE%<br>"
];